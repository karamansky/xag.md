...
if ( ! function_exists('kastell_mkdf_contact_form_7_options_map') ) {

	function kastell_mkdf_contact_form_7_options_map() {

		kastell_mkdf_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'kastell'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = kastell_mkdf_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'kastell')
		));

		//Text Typography

		$typography_text_group = kastell_mkdf_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'kastell'),
			'description'	=> esc_html__('Setup typography for form elements text', 'kastell'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = kastell_mkdf_add_admin_row(array(
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'kastell'),
		));
		...
		$typography_text_row2 = kastell_mkdf_add_admin_row(array(
		...
		$typography_text_row3 = kastell_mkdf_add_admin_row(array(
		...
		$typography_label_group = kastell_mkdf_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'kastell'),
			'description'	=> esc_html__('Setup typography for form elements label', 'kastell'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = kastell_mkdf_add_admin_row(array(
		...
		$typography_label_row2 = kastell_mkdf_add_admin_row(array(
		...
		$background_border_group = kastell_mkdf_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'kastell'),
			'description'	=> esc_html__('Setup form elements background and border style', 'kastell'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = kastell_mkdf_add_admin_row(array(
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'kastell')
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'kastell')
		));

		$background_border_row2 = kastell_mkdf_add_admin_row(array(
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'kastell'),
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'kastell')
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'kastell')
		));

		$background_border_row3 = kastell_mkdf_add_admin_row(array(
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'kastell'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'kastell'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = kastell_mkdf_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'kastell'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = kastell_mkdf_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'kastell'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'kastell'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'kastell'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'kastell'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = kastell_mkdf_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'kastell'),
			'description'	=> esc_html__('Setup form elements margin', 'kastell'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = kastell_mkdf_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'kastell'),
			'description'	=> esc_html__('Enter height for textarea form element', 'kastell'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = kastell_mkdf_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'kastell'),
			'description'	=> esc_html__('Setup button text typography', 'kastell'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = kastell_mkdf_add_admin_row(array(
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Hover Text Color', 'kastell')
		));
		...
		$button_typography_row2 = kastell_mkdf_add_admin_row(array(
		...
		$button_background_border_group = kastell_mkdf_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'kastell'),
			'description'	=> esc_html__('Setup button background and border style', 'kastell'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = kastell_mkdf_add_admin_row(array(
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'kastell')
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'kastell')
		));

		$button_background_border_row2 = kastell_mkdf_add_admin_row(array(
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'kastell')
		));
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'kastell')
		));

		$button_background_border_row3 = kastell_mkdf_add_admin_row(array(
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'kastell'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		kastell_mkdf_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'kastell'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = kastell_mkdf_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'kastell')
		));
        ...
        $panel_contact_form_style_3 = kastell_mkdf_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'kastell')
        ));
        ...
        $typography_label_row3 = kastell_mkdf_add_admin_row(array(
        ...
        $button_typography_row3 = kastell_mkdf_add_admin_row(array(
	...
	add_action( 'kastell_mkdf_options_map', 'kastell_mkdf_contact_form_7_options_map', 20);
}