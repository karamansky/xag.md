...
$blog_list_image_id = ! empty( $image_meta ) && kastell_mkdf_blog_item_has_link() ? kastell_mkdf_get_attachment_id_from_url( $image_meta ) : '';
$background_image   = '';
...
?>
<?php if ( $has_featured ) { ?>
	<div class="mkdf-post-image-background" <?php kastell_mkdf_inline_style($background_image); ?>>
