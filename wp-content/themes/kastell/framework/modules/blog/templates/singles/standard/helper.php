...
if( !function_exists('kastell_mkdf_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function kastell_mkdf_get_blog_single_holder_classes($classes) {
    ...
    add_filter( 'kastell_mkdf_blog_single_holder_classes', 'kastell_mkdf_get_blog_single_holder_classes' );
}
