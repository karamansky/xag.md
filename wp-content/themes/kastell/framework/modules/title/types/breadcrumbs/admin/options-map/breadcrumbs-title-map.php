...
if ( ! function_exists('kastell_mkdf_breadcrumbs_title_type_options_map') ) {
	function kastell_mkdf_breadcrumbs_title_type_options_map($panel_typography) {
		
		kastell_mkdf_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'kastell' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = kastell_mkdf_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'kastell' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'kastell' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = kastell_mkdf_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = kastell_mkdf_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = kastell_mkdf_add_admin_row(
				array(
	...
	add_action( 'kastell_mkdf_additional_title_typography_options_map', 'kastell_mkdf_breadcrumbs_title_type_options_map');
}