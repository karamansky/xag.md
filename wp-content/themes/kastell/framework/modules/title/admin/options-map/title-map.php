...
if ( ! function_exists( 'kastell_mkdf_get_title_types_options' ) ) {
	function kastell_mkdf_get_title_types_options() {
		$title_type_options = apply_filters( 'kastell_mkdf_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'kastell_mkdf_get_title_type_default_options' ) ) {
	function kastell_mkdf_get_title_type_default_options() {
		$title_type_option = apply_filters( 'kastell_mkdf_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('kastell_mkdf_title_options_map') ) {
	function kastell_mkdf_title_options_map() {
		$title_type_options        = kastell_mkdf_get_title_types_options();
		$title_type_default_option = kastell_mkdf_get_title_type_default_options();
		...
		$panel_title = kastell_mkdf_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'kastell')
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'kastell' ),
				'parent'        => $panel_title,
				'args'          => array(
					'dependence'             => true,
			...
			$show_title_area_container = kastell_mkdf_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				kastell_mkdf_add_admin_field(
					...
					kastell_mkdf_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'kastell' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'kastell_mkdf_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = kastell_mkdf_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = kastell_mkdf_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'kastell' ),
					'description' => esc_html__( 'Define styles for page title', 'kastell' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = kastell_mkdf_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = kastell_mkdf_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = kastell_mkdf_add_admin_row(
					array(
			...
			kastell_mkdf_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'kastell' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = kastell_mkdf_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'kastell' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'kastell' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = kastell_mkdf_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = kastell_mkdf_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = kastell_mkdf_add_admin_row(
					array(
		...
		do_action( 'kastell_mkdf_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'kastell_mkdf_options_map', 'kastell_mkdf_title_options_map', 6);
}