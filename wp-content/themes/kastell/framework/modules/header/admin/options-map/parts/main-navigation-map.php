...
if ( ! function_exists( 'kastell_mkdf_get_hide_dep_for_header_main_menu_options' ) ) {
	function kastell_mkdf_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'kastell_mkdf_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'kastell_mkdf_header_main_navigation_options_map' ) ) {
	function kastell_mkdf_header_main_navigation_options_map() {
		$hide_dep_options = kastell_mkdf_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = kastell_mkdf_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'kastell' ),
		...
		kastell_mkdf_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'kastell' )
			)
		);
		...
		$drop_down_group = kastell_mkdf_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'kastell' )
			)
		);
		
		$drop_down_row1 = kastell_mkdf_add_admin_row(
			array(
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'kastell' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'kastell' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'kastell' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'kastell' )
				)
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dropdown Position', 'kastell' ),
				'description'   => esc_html__( 'Enter value in percentage of entire header height', 'kastell' ),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => '%'
				)
		...
		$first_level_group = kastell_mkdf_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Active Text Color', 'kastell' ),
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'kastell' ),
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'kastell' ),
			)
		);
		
		$first_level_row4 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'kastell' ),
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'kastell' ),
			)
		);
		
		$first_level_row5 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'kastell' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'kastell' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = kastell_mkdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'kastell' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'kastell' )
			)
		);
		...
		$second_level_wide_group = kastell_mkdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'kastell' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'kastell' )
			)
		);
		
		$second_level_wide_row1 = kastell_mkdf_add_admin_row(
			array(
		...
		$second_level_wide_row2 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = kastell_mkdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_group',
				'title'       => esc_html__( '3nd Level Menu', 'kastell' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'kastell' )
			)
		);
		
		$third_level_row1 = kastell_mkdf_add_admin_row(
			array(
		...
		$third_level_row2 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_row3 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = kastell_mkdf_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'kastell' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'kastell' )
			)
		);
		
		$third_level_wide_row1 = kastell_mkdf_add_admin_row(
			array(
		...
		$third_level_wide_row2 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = kastell_mkdf_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'kastell_mkdf_header_main_navigation_options_map', 'kastell_mkdf_header_main_navigation_options_map', 10, 1 );
}