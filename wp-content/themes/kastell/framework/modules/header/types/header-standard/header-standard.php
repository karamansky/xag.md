...
class HeaderStandard extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters = apply_filters( 'kastell_mkdf_header_standard_parameters', $parameters );
	...
	public function calculateHeightOfTransparency() {
		...
		$menu_background_color             = kastell_mkdf_options()->getOptionValue( 'menu_area_background_color' );
		$menu_background_transparency      = kastell_mkdf_options()->getOptionValue( 'menu_area_background_transparency' );
		$menu_grid_background_color        = kastell_mkdf_options()->getOptionValue( 'menu_area_grid_background_color' );
		$menu_grid_background_transparency = kastell_mkdf_options()->getOptionValue( 'menu_area_grid_background_transparency' );
		...
		if ( $menuAreaTransparent ) {
			...
			if ( ( $sliderExists && kastell_mkdf_is_top_bar_enabled() )
			     || kastell_mkdf_is_top_bar_enabled() && kastell_mkdf_is_top_bar_transparent()
			) {
				$transparencyHeight += kastell_mkdf_get_top_bar_height();
			}
		}
