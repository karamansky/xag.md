...
if ( ! function_exists( 'kastell_mkdf_vertical_menu_styles' ) ) {
	function kastell_mkdf_vertical_menu_styles() {
	...
	add_action( 'kastell_mkdf_style_dynamic', 'kastell_mkdf_vertical_menu_styles' );
}

if ( ! function_exists( 'kastell_mkdf_vertical_main_menu_styles' ) ) {
	/**
	 * Generates styles for vertical main main menu
	 */
	function kastell_mkdf_vertical_main_menu_styles() {
		...
		if ( ! empty( $menu_top_margin ) ) {
			$menu_holder_styles['margin-top'] = kastell_mkdf_filter_px( $menu_top_margin ) . 'px';
		}
		if ( ! empty( $menu_bottom_margin ) ) {
			$menu_holder_styles['margin-bottom'] = kastell_mkdf_filter_px( $menu_bottom_margin ) . 'px';
		}
		...
		echo kastell_mkdf_dynamic_css( $menu_holder_selector, $menu_holder_styles );
	...
	add_action( 'kastell_mkdf_style_dynamic', 'kastell_mkdf_vertical_main_menu_styles' );
}