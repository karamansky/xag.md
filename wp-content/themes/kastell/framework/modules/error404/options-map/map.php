...
if ( ! function_exists( 'kastell_mkdf_error_404_options_map' ) ) {
	function kastell_mkdf_error_404_options_map() {
		
		kastell_mkdf_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'kastell' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = kastell_mkdf_add_admin_panel(
			array(
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Choose a border bottom color for header area', 'kastell' )
			)
		);
		...
		$panel_404_options = kastell_mkdf_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Pattern Background Image', 'kastell' ),
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'kastell' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'name'          => '404_title',
				'default_value' => '',
				'label'         => esc_html__( 'Title', 'kastell' ),
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'kastell' )
			)
		);
		...
		$first_level_group = kastell_mkdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'kastell' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'name'          => '404_subtitle',
				'default_value' => '',
				'label'         => esc_html__( 'Subtitle', 'kastell' ),
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'kastell' )
			)
		);
		...
		$second_level_group = kastell_mkdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'kastell' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'kastell' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'kastell' )
			)
		);
		...
		$third_level_group = kastell_mkdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'kastell' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'kastell' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'kastell' )
			)
		);
		...
		kastell_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'kastell' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'kastell' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'kastell' ),
					'light-style' => esc_html__( 'Light', 'kastell' )
				)
			)
		);
	}
	
	add_action( 'kastell_mkdf_options_map', 'kastell_mkdf_error_404_options_map', 19 );
}