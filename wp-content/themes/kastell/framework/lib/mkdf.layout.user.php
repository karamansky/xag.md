...
/*
   Class: KastellMkdfUserField
   A class that initializes KastellMkdf User Field
*/

class KastellMkdfUserField implements iKastellMkdfRender {
	private $type;
	private $name;
	private $label;
	private $description;
	...
	function __construct( $type, $name, $label = "", $description = "", $options = array(), $args = array() ) {
		...
		$this->args        = $args;
		add_filter( 'kastell_mkdf_user_fields', array( $this, 'addFieldForEditSave' ) );
	}
...
abstract class KastellMkdfUserFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array() );
}

class KastellMkdfUserFieldText extends KastellMkdfUserFieldType {
...
class KastellMkdfUserFieldSelect extends KastellMkdfTaxonomyFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array() ) {
...
/*
   Class: KastellMkdfUserGroup
   A class that initializes Mikado User Group
*/
class KastellMkdfUserGroup implements iKastellMkdfLayoutNode, iKastellMkdfRender {
	public $children;
	public $title;
	public $description;
...
class KastellMkdfUserFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $hidden = false ) {

		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new KastellMkdfUserFieldText();
				$field->render( $name, $label, $description, $options, $args, $hidden );
				break;
			case 'select':
				$field = new KastellMkdfUserFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $hidden );
				break;
			default:
				break;
