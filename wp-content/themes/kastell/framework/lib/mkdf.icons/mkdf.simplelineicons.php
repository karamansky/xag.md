...
class KastellMkdfSimpleLineIcons implements iKastellMkdfIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'kastell'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'kastell'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'kastell'),
            'icon-social-facebook'    => esc_html__('Facebook', 'kastell'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'kastell'),
            'icon-social-github'      => esc_html__('Github', 'kastell'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'kastell'),
            'icon-social-instagram'   => esc_html__('Instagram', 'kastell'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'kastell'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'kastell'),
            'icon-social-reddit'      => esc_html__('Reddit', 'kastell'),
            'icon-social-skype'       => esc_html__('Skype', 'kastell'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'kastell'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'kastell'),
            'icon-social-spotify'     => esc_html__('Spotify', 'kastell'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'kastell'),
            'icon-social-twitter'     => esc_html__('Twitter', 'kastell'),
            'icon-social-youtube'     => esc_html__('Youtube', 'kastell')
        );
    }
