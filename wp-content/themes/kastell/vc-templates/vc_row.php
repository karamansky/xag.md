...
$row_content_width = $anchor = $anchor_button = $anchor_button_text = $anchor_button_section = $content_text_aligment = $simple_background_color = $simple_background_image = $disable_background_image = $parallax_background_image = $parallax_bg_speed = $parallax_bg_height = '';
...
if($anchor_button == 'yes'){
    $css_classes[]='vc_row-has-anchor-button';
}
...
if($row_content_width === 'grid'){
	$mkdf_row_wrapper_start .= '<div class="mkdf-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" '.esc_attr($grid_row_datas).' ' . kastell_mkdf_get_inline_style( $mkdf_grid_row_styles ) . '><div class="mkdf-row-grid-section">';
	$mkdf_row_wrapper_end .= '</div></div>';
}
$anchor_button_html = '';
if($anchor_button == 'yes'){
    $anchor_button_html = '<a class="mkdf-anchor" href="#'.$anchor_button_section.'" target="_self">'.$anchor_button_text.'</a>';
}
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . kastell_mkdf_get_inline_style( $mkdf_vc_row_styles ) . '>';
$output .= wpb_js_remove_wpautop( $content );
$output .= $anchor_button_html;
$output .= '</div>';
$output .= $mkdf_row_wrapper_end;
$output .= $after_output;

echo kastell_mikado_get_module_part( $output );
