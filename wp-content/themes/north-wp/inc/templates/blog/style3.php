...
<div class="row align-center">
	<div class="small-12 medium-10 large-9 columns <?php echo esc_attr( 'pagination-' . $blog_pagination_style ); ?>" data-security="<?php echo esc_attr( wp_create_nonce( 'thb_blog_ajax' ) ); ?>">
		<?php
		if ( have_posts() ) :
			while ( have_posts() ) :
				the_post();
