...
function thb_ocdi_after_import( $selected_import ) {
	...
	$logged_in  = get_term_by( 'name', 'loggedin', 'nav_menu' );
	$logged_out = get_term_by( 'name', 'loggedout', 'nav_menu' );
	...
	set_theme_mod(
		...
		array(
			...
			'acc-menu-in'  => $logged_in->term_id,
			'acc-menu-out' => $logged_out->term_id,
